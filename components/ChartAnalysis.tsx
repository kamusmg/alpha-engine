...
import { ChartAnalysisResult, ChartAnalysisRecommendation } from '../types';
import { formatCurrency, formatPercentage } from '../utils/formatters';
import { useLanguage } from '../contexts/LanguageContext';
import { translations } from '../utils/translations';
import AnimatedDropzoneIcon from './AnimatedDropzoneIcon';
...
const ChartAnalysis: React.FC = () => {
    ...
    const analyzeImage = useCallback(async (file: File) => {
        ...
        reader.onloadend = async () => {
            ...
            try {
                const analysisResult = await analyzeChartImage(base64, file.type, language);
                setResult(analysisResult);
            } catch (e: any) {
                setToastError(t.analysisFailed);
                setImage(null);
            } finally {
                setIsLoading(false);
            }
