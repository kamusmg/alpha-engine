...
import { fetchRobustnessAudit } from '../services/geminiService';
...
const RobustnessAudit: React.FC = () => {
    ...
    const handleRunAudit = useCallback(async () => {
        ...
        setAuditReport(null);
        try {
            const report = await fetchRobustnessAudit();
    ...
    return (
        <div className="bg-gradient-to-br from-surface to-background/50 border border-border/70 rounded-xl p-6 shadow-lg">
            <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-text ml-4">Auditoria Geral de Robustez (AGR)</h3>
            </div>
            <p className="text-text-secondary max-w-4xl mb-6">
                Execute um teste de estresse simulando 100 operações em cenários de mercado extremos para validar a robustez dos modelos preditivos da IA.
            </p>
            ...
            {isLoading && (
                <div className="text-center py-8">
                    ...
                    <p className="mt-4 text-lg font-semibold text-secondary animate-pulse">Executando simulação de 100 trades...</p>
            ...
            {error && (
                 <div className="text-center p-4 bg-danger/20 text-danger rounded-lg">
                    <p className="font-semibold">Erro na Auditoria</p>
                ...
                <div className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-1 flex flex-col items-center justify-center bg-background/50 p-4 rounded-lg border border-border/50">
                            ...
                            <h4 className="text-sm font-bold text-text-secondary uppercase tracking-wider mt-2">Taxa de Sucesso</h4>
                        </div>
                        {/* Net Profit & Conclusion */}
                        <div className="md:col-span-2 bg-background/50 p-6 rounded-lg border border-border/50 space-y-4">
                             <div>
                                <h4 className="text-sm font-bold text-text-secondary uppercase tracking-wider">Resultado Líquido Total</h4>
                                ...
                                <p className="text-sm text-text-secondary">(de 100 trades de $100)</p>
                            </div>
                            <div className="border-t border-border/50 pt-4">
                                <h4 className="text-sm font-bold text-text-secondary uppercase tracking-wider">Conclusão da Auditoria</h4>
                    ...
                    <div className="bg-background/50 p-6 rounded-lg border border-border/50">
                        <h4 className="text-lg font-bold text-primary mb-2">Diagnóstico Detalhado dos Erros</h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-green-600/10 border border-green-500/30 rounded-lg p-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h6 className="font-bold text-green-300">Exemplos de Sucesso</h6>
                         ...
                         <div className="bg-red-600/10 border border-red-500/30 rounded-lg p-4">
                             <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h6 className="font-bold text-red-300">Exemplos de Falha</h6>
                                     <ul className="list-disc list-inside text-sm text-text-secondary mt-2 space-y-1">
