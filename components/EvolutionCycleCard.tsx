...
import { SelfAnalysis, BacktestAnalysisResult } from '../types';
import SelfAnalysisCard from './SelfAnalysisCard';
import UserIcon from './UserIcon';
import { fetchSupervisorDirective } from '../services/geminiService';
  ...
  useEffect(() => {
    const getDirective = async (analysis: SelfAnalysis, promptText: string) => {
        try {
            ...
            const directive = await fetchSupervisorDirective(analysis, promptText);
            setSupervisorDirective(directive);
        } catch (e: any) {
